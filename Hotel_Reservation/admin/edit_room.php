				...
				<div class = "col-md-4">
					...
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							<label>Hotel </label>
							<input type = "text" value = "<?php echo $fetch['hotel_name']?>" class = "form-control" name = "hotel_name" />
						</div>
						<div class = "form-group">
							...
							<select class = "form-control" required = required name = "room_type">
								...
								<option value = "Village" <?php if($fetch['room_type'] == "village"){echo "selected";}?>>Village</option>
								<option value = "Eco-Friendly" <?php if($fetch['room_type'] == "eco"){echo "selected";}?>>Eco-Friendly</option>
							</select>
						</div>
						<div class = "form-group">
							<label>Price </label>
