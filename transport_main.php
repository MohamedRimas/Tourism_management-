...
href="https://fonts.googleapis.com/css2?family=Montserrat:wght@500;600;700;800&family=Poppins:wght@400;500;600;700&display=swap"
  rel="stylesheet">
        ...
        <link href="css1/templatemo-pod-talk.css" rel="stylesheet">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                            <div class="team-thumb bg-white shadow-lg">
                                <img src="images1\vehicle\bicycle2.jpg" class="about-image img-fluid" alt="">

                                <div class="team-info">
                                    <h4 class="mb-2">
                                        Bicycle
                                        <img src="images1/verified.png" class="verified-image img-fluid" alt="">
                                    </h4>
                                ...
                                <div class="social-share">
                                    ...
                                    <a href="book_teansport.php" class="btn custom-btn custom-border-btn smoothscroll">Select</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="team-thumb bg-white shadow-lg">
                                <img src="images1\vehicle\bike1.jpg" class="about-image img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="team-thumb bg-white shadow-lg">
                                <img src="images1\vehicle\threewheeler2.jpg" class="about-image img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                            <div class="team-thumb bg-white shadow-lg">
                                <img src="images1\vehicle\hiace1.jpeg" class="about-image img-fluid" alt="">
